...
export const moduleConfigs: Record<Modules, ModuleConfig> = {
  ...
  i18n: {
    ...
    tasksPostInstall: [],
    htmlForIndexVue:
      "<p>Check out the nuxt-i18n demo page here: <nuxt-link to=\"/i18n\" class=\"underline text-blue-600\">Click me to test nuxt-i18n setup!</nuxt-link></p>",
  },
  "morpheme-auth": {
